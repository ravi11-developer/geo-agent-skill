...
from eval.runners.serve_synthetic import start_server
from eval.scoring.adjudicate import adjudicate_site, validate_against_gold

SYNTHETIC_DIR = os.path.join(PROJECT_ROOT, "eval", "sites", "synthetic")
...
def main() -> None:
    ...
    subprocess.run([sys.executable, os.path.join(PROJECT_ROOT, "eval", "runners", "capture_corpus.py"),
