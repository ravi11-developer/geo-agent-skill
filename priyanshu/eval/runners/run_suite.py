...
from eval.scoring.normalize import normalize_report, normalize_finding
from eval.scoring.detection import match_findings, score_false_positive_rate, score_per_category
from eval.scoring.evidence import score_evidence, score_action, score_severity_accuracy, score_schema_validity
from eval.scoring.proactive import score_proactive
...
SYNTHETIC_SITES_DIR = os.path.join(PROJECT_ROOT, "eval", "sites", "synthetic")
