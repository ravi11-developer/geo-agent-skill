...
The agent lives at ``agents/B-coverage/`` with each skill's executable at
...
this script derives one from the other:
    ...
    python agents/B-coverage/tools/build_submission.py            # ../../../marketplace_submission
    python agents/B-coverage/tools/build_submission.py --out DIR --zip
