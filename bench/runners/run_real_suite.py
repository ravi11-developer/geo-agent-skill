...
from bench.scoring.normalize import normalize_finding
from bench.scoring.evidence import score_evidence, score_action, score_schema_validity
from bench.scoring.adjudicate import CATEGORIES, adjudicate_site, score_report, validate_against_gold

CORPUS_DIR = os.path.join(PROJECT_ROOT, "bench", "sites", "real", "corpus")
...
def run_agent_on(agent: str, url: str) -> dict[str, Any]:
    ...
    try:
        module = registry.load(agent)  # subprocess-backed; see bench/registry.py
